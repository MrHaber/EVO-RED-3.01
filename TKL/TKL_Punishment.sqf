...
If ((Vehicle Player) == Player) Then {DisableUserInput True;}	Else
	{
...
While {Floor _WaitingTime > 0} Do
	...
	TitleText [format [ localize "STR_TKL_KILLED_A_COLLEAGUE:_%1/%2\n[LOCKED:_%3]",GetMarkerPos ((GetPlayerUID Player)+"_Side") Select 0,TKL_Limit,_min_Text + ":" + _s_Text],"BLACK FADED"];
	Sleep 1;
	};
HintSilent "";
